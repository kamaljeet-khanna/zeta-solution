...
public class AddressBookTest {
	...
	public void testAddressBook() {
		try {
			...
			assertEquals("1234567890",phoneNumberWork.getPhoneNumber(),phoneNumberWork.getPhoneNumber());
			assertEquals("0987654321",phoneNumberHome.getPhoneNumber(),phoneNumberHome.getPhoneNumber());
			assertEquals("1234098765",phoneNumberOffice.getPhoneNumber(),phoneNumberOffice.getPhoneNumber());
			assertEquals("work",addressWork.getLabel(),addressWork.getLabel());
